...
// FROM https://github.com/davidscotttufts/php-barcode
...
class BARCODE{
    ...
    function print() {
        ...
        } elseif ( strtolower($this->code_type) == "code128a" ) {
            $chksum = 103;
            $this->text = strtoupper($this->text); // Code 128A doesn't support lower case
            // Must not change order of array elements as the checksum depends on the array's key to validate final code
        ...
        if ( $this->base64 !==false) {
            ...
            //  echo '<img src="'.$imageb64.'" height="60" width="180">';
