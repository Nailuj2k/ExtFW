<?php
    ...
    abstract class HTML{
        ...
        public static function css($link,$media='screen',$extra=''){
            ...
            // prevent duplicte loading of the same script
            foreach(self::$elements['css'] as $element){
                if(strpos($element, $link) !== false){
                    return; // CSS file already included, skip adding it again
                }
            }
        ...
        public static function js($src,$extra=''){
            ...
            // prevent duplicte loading of the same script
            foreach(self::$elements['js'] as $element){
                if(strpos($element, $src) !== false){
                    return; // Script already included, skip adding it again
                }
            }
        ...
        public static function render($type){
            ...
            // delete all elements of the specified type from the array after rendering
            self::$elements[$type] = [];
