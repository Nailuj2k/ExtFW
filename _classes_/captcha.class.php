...
class Captcha{
    ...
    public static $innumerate = false;
    ...
    public static function create( $min = 0, $max = 4 ){
            ...
            $_captcha['help']     = t('SPAM_PROTECTION','Protección anti-spam','Anti spam');
            $_captcha['min']      = 1;
            $_captcha['max']      = 13;
            $_captcha['ops']      = ['+','-','x','sqrt','**'];
            ...
            if (self::$innumerate){ $_captcha['op']=0; $_captcha['min']=1; $_captcha['max']=5; } // solo sumas, sumandos 1-5
