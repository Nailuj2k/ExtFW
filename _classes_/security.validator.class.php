...
class SecurityValidator {
    ...
    /**
     * Normaliza un string para detección de ataques: elimina null bytes y decodifica
     * entidades HTML iterativamente para neutralizar double-encoding.
     * NO produce output seguro para HTML — usar htmlspecialchars() para eso.
     *
     * @param string $value String a normalizar
     * @return string String normalizado (decodificado)
     */
    public static function normalizeForDetection(string $value): string {
        // Remover null bytes
