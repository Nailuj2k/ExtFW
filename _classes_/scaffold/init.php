<?php 
    ...
    if(!OUTPUT){
        HTML::css(SCRIPT_DIR_CLASSES.'/scaffold/themes/'.Table::$theme.'/style.css?ver=2.1.2');
        HTML::css(SCRIPT_DIR_CLASSES.'/scaffold/themes/'.Table::$theme.'/style.form.css?ver=1.8.9');
        HTML::css(SCRIPT_DIR_CLASSES.'/scaffold/themes/'.Table::$theme.'/style.paginator.css?ver=1.6.7');
        ...
        HTML::css(SCRIPT_DIR_JS.'/image_editor/image_editor.css?ver=1.1.6');
        ...
        HTML::js(SCRIPT_DIR_JS.'/image_editor/image_editor.js?ver=1.1.6');
    }