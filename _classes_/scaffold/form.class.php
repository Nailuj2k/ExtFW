...
class formFile extends formInput{
  ...
  public function __construct($element,$value=false) {
    ...
    $this->ratio = $element->ratio ? $element->ratio : false;
  ...
  public function render(){
        ...
        if ($this->image_editor) {
            ...
            <img class="editable-image" style="width:<?=$this->image_width?>;height:<?=$this->image_height?>;display:inline-block;" src="<?=$this->uploaddir?>/<?=$this->value?>" alt="Preview"<?php if ($this->ratio !== false && $this->ratio !== null && $this->ratio !== ''): ?> data-ratio="<?=htmlspecialchars((string)$this->ratio, ENT_QUOTES, 'UTF-8')?>"<?php endif; ?>><!-- data-dest="dest-img1" data-ajaxurl="ajax.php?op=image-crop"-->
