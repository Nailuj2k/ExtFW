...
Class Crypt{
    ...
    */
    ...
    // TODO: sha1 como KDF es debil (brute-force rapido). Si se activa este metodo en produccion,
    // reemplazar por: $key = hash_pbkdf2('sha256', $key, $salt, 100000, 16, true);
    // El $salt habria que guardarlo al inicio del archivo (como el IV) y pasarlo como parametro.
    // Ver tambien decryptFile(). El modulo assymetric_crypt NO usa estas funciones.
    ...
    // TODO: ver encryptFile() — mismo problema de KDF debil con sha1.
