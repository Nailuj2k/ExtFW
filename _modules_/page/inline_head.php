...
if($editable) {
    ...
    HTML::css(SCRIPT_DIR_CLASSES.'/scaffold/themes/default/style.form.css?ver=1.5.7');
    ...
    //HTML::css('https://cdnjs.cloudflare.com/ajax/libs/cropperjs/1.5.12/cropper.min.css');
    //HTML::css(SCRIPT_DIR_JS.'/image_editor/image_editor.css?ver=1.1.0');

}



HTML::css(SCRIPT_DIR_MODULES.'/page/inline_edit.css?ver=1.4.6');
...
if($editable) {
    ...
    //HTML::css(SCRIPT_DIR_JS.'<!--<script src="https://cdnjs.cloudflare.com/ajax/libs/cropperjs/1.5.12/cropper.min.js"></script>-->
        ...
        //HTML::js(SCRIPT_DIR_JS.'/image_editor/image_editor.js?ver=1.1.0');
