<?php
  ...
  //$db_engine = 'crud';
    ...
    function Administrador(){
       ...
       /*     
       $a = AreasACL::getAreasWithPermission('page', 'edit', $_SESSION['userid']) ;
       $item = Table::getFieldsValues("SELECT item_id,item_parent,item_name FROM CLI_ITEM WHERE item_url= '".$_ARGS[1]."'");
       if (in_array($item['item_name'], $a)) return true;
       */
