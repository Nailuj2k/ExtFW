...
$user_deleted = new Field();
$user_deleted->type      = 'int';
$user_deleted->len       = 1;
$user_deleted->fieldname = 'user_deleted';
$user_deleted->label     = 'User deleted';
$user_deleted->editable  = false ;
$user_deleted->sortable  = true;
$user_deleted->searchable  = true;
$tabla->addCol($user_deleted);
...
$user_points = new Field();
$user_points->type      = 'decimal';
$user_points->len       = '5,2';
$user_points->fieldname = 'user_points';
$user_points->label     = 'User points';
$user_points->editable  = false ;
$user_points->sortable  = true;
$user_points->searchable  = true;
$tabla->addCol($user_points);
