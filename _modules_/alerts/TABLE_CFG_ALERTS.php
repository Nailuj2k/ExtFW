...
$type->len       = 7;
$type->type      = 'select';
$type->values    = array('1'=>'Aviso normal','2'=>'Popup','3'=>'Imagen','4'=>'Redirect','5'=>'Tip','6'=>'login');
$type->editable  = true;
...
$slider->label     = 'Slider';   
$slider->textafter = 'Ver ésta entrada en el slider (Solo para tipo \'imagen\', aunque no esté activa).';
