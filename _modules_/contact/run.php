<?php 
    ...
    if(CFG::$vars['captcha']['enabled'] && CFG::$vars['captcha']['google_v3']['enabled']) { 
          ...
          //  include(SCRIPT_DIR_CLASSES.'/captcha.class.php'); 
            ...
            $fcaptcha->label = t('form_captcha_label','Resolver').' ('. t('SPAM_PROTECTION').')';
...
*/
          ...
          $chk_priv = new Field();
          $chk_priv->label = t('PRIVACY_POLICY_ACCEPTANCE','Haciendo clic, usted acepta la <a class="open_href" target="new" title="Política de privacidad" href="page/politica-de-privacidad">política de privacidad</a> de este sitio web. <span style="color:red">(Campo obligatorio)</span>','I accept by clicking, you accept the <a class="open_href" target="new" title="Privacy Policy" href="page/politica-de-privacidad">privacy policy</a> of this website. <span style="color:red">(Required field)</span>'); 
          $chk_priv->help = '';
          $chk_priv->name = 'chk_priv';

          $chk_publi = new Field();
          $chk_publi->label = t('CONSENT_RECV_PUBLI','Consiento el uso de mis datos personales para recibir publicidad de su entidad.','I consent to the use of my personal data to receive advertising from your entity.');
