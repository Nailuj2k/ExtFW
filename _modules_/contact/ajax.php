<?php
    ...
    $_POST['nombre'] = 'Lucas Grijander';
    $_POST['notas'] = 'A guan, a peich, a jarl, a jarenaor, a peticaor ,a wenipeich';
    $_POST['phone'] = '666666666';
          ...
          // $verify = json_decode(file_get_contents($url));
           if ($captcha) {
              ...
              //$message .= 'Tipo: '   . $_POST['tipo'] . "<br>";
                ...
                $m->SMTPSecure = CFG::$vars['smtp']['ssl'];          //'tls';
