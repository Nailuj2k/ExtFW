...
$child_field_name = new Field();
$child_field_name->fieldname = 'CHILD_FIELD_NAME';
$child_field_name->label     = 'Child field name';   
$child_field_name->len       = 40;
$child_field_name->type      = 'varchar';
$child_field_name->editable  = Administrador(); 
$child_field_name->textafter = 'Select dependiente';
$child_field_name->hide  = true;

$child_ajax_url = new Field();
$child_ajax_url->fieldname = 'CHILD_AJAX_URL';
$child_ajax_url->label     = 'Child ajax url';   
$child_ajax_url->len       = 100;    
$child_ajax_url->type      = 'varchar';
$child_ajax_url->editable  = Administrador();
$child_ajax_url->default_value = '/control_panel/ajax/op=list';
$child_ajax_url->hide  = true;

$child_sql = new Field();
$child_sql->fieldname = 'CHILD_SQL';
$child_sql->label     = 'Child sql';   
$child_sql->len       = 200;    
$child_sql->type      = 'varchar';
$child_sql->editable  = Administrador();  
$child_sql->hide  = true;
/*
child_ajax_url   = '/control_panel/ajax/op=list';
child_fieldname  = 'ID_STATE';
child_source_sql = "provincia_from_pais";
child_sql = "SELECT * FROM CLI_PROVINCIAS WHERE ID_PAIS=[ID_PAIS] ORDER BY PROVINCIA";
*/
...
$type->textafter = '  Para tipo select, el tipo real será varchar si len>5, int si es menor';
...
//$len->textafter = 'Longitud máxima del campo, en caracteres. Para campos tipo date, textarea y file se ignora este valor.';
...
$field_order = new Field();
$field_order->type      = 'int';
$field_order->len       = 5;
$field_order->fieldname = 'FIELD_ORDER';
$field_order->label     = 'Order';
$field_order->editable  = true;
$field_order->sortable  = true;
$field_order->searchable  = true;
$field_order->default_value = 10;
...
$tabla->addCol($child_field_name);
$tabla->addCol($child_ajax_url);
$tabla->addCol($child_sql);
...
$tabla->addCol($field_order);

$tabla->addActiveCol();
//$tabla->addWhoColumns();
$tabla->orderby = 'FIELDSET,FIELD_ORDER';
