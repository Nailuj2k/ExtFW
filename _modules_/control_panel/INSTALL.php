...
if (Administrador()) {
    ...
    if ($_ARGS[2]=='root'){
       ...
       //   $str_sql_add_user_role = "INSERT INTO ".TB_ACL_USER_ROLES." (id_user,id_role) VALUES( 1 , 11)";
            ...
            ALTER DATABASE `tu_basededatos` CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;


            ¡Cuidadín:

            CONVERT TO reescribe cada tabla.
            Longitud de índice (MyISAM, máx 1000 bytes/clave). utf8mb4 usa 4 bytes/char.
            Un índice sobre VARCHAR(255) pasa a 255×4=1020 bytes y el ALTER falla con "Specified key was too long". 
            En ese caso hay que reducir esa columna (p.ej. VARCHAR(250)) o usar índice de prefijo antes de convertir. 
            Para ver cuáles tienen ese riesgo:
