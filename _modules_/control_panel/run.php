...
if($ie){
    ...
    }else if(Operador() && !Administrador()) {
                    ...
                    <div id="tab-cfg-log">
                        ...
                        <div id="tabs-cfg-log" class="form-tabs" data-simpletabs>
                            <ul>
                                ...
                                <li><a href="#tab-cfg-log-rate">Rate</a></li>
                            ...
                            <div id="tab-cfg-log-rate">
                                <?php /* Log del rate limiter (LOG::rate → rate_YYYYMMDD.log).
                                         No depende de CFG::$vars['log']: LOG::rate escribe siempre. */ ?>
                                <div style="text-align:right;padding: 5px 5px 0 5px;">
                                    <a class="btn" id="ratelog-test-btn" title="Escribe una línea de prueba en el rate log (verifica que el visor funciona)">Test&nbsp; <i class="fa fa-flask"></i></a>
                                    <a class="btn btn-primary" id="start-stop-ratelog-live"><?=t('START')?>&nbsp; <i class="fa fa-play"></i></a>
                                </div>

                                <div id="ratelog-lines"></div>
                            </div>
                ...
                <div id="tab-cfg-updates">
                    ...
                    <div class="cfg-updates-col" id="system-info">
                        ...
                        if (!extension_loaded('imagick')){
                           ?><tr><td class="warn" colspan="2"> Imagick functions is not installed for PHP. Install with<br><pre class='code'>~ apt install -y imagemagick ghostscript php8.2-imagick</pre></td></tr><?php
                        }
