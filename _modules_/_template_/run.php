<div class="inner">
    ...
    <div id="div-form-test" style="border:1px solid silver;padding:10px;">
        ...
        <form id="test_form" action="<?=MODULE?>/ajax/option=test_form" class="NNNNno-ajax">
            ...
            <input type="submit" id="submit2" class="btn btn-small btn-secondary" value="Enviar (submit)"> <!-- Submit tradicional, para que el formulario sea funcional sin JavaScript -->
        </form>
        <h4>Respuesta</h4>
