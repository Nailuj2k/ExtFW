...
$classmap = [
    ...
    'AreasACL'       => SCRIPT_DIR_MODULES . '/acl/areas_acl.class.php',  
    ...
    'BitcoinRpc'     => SCRIPT_DIR_CLASSES . '/bitcoin_rpc.class.php',
    'MempoolApi'     => SCRIPT_DIR_CLASSES . '/bitcoin_rpc.class.php',
    ...
    'Oracle_OCI'       => SCRIPT_DIR_CLASSES . '/db/db.oracle.class.php',  
    ...
    'Dompdf\\Cpdf'      => SCRIPT_DIR_VENDOR  . '/dompdf/dompdf/lib/Cpdf.php',
    ...
    'Spotify'           => SCRIPT_DIR_MODULES . '/spotify/spotify.class.php',

    'PHP_ICO'               => SCRIPT_DIR_CLASSES . '/ico.class.php',
    'FaviconImageGenerator' => SCRIPT_DIR_CLASSES . '/favicon.class.php',
    'FaviconHtmlGenerator'  => SCRIPT_DIR_CLASSES . '/favicon.class.php',
...
spl_autoload_register(function ($class) {
    $map = [
        'phpseclib3\\' => SCRIPT_DIR_VENDOR . '/phpseclib/phpseclib/phpseclib',
        'ParagonIE\\ConstantTime\\' => SCRIPT_DIR_VENDOR . '/paragonie/constant_time_encoding/src',
        'Dompdf\\' => SCRIPT_DIR_VENDOR . '/dompdf/dompdf/src',
        'FontLib\\' => SCRIPT_DIR_VENDOR . '/dompdf/php-font-lib/src/FontLib',
        'Svg\\' => SCRIPT_DIR_VENDOR . '/dompdf/php-svg-lib/src/Svg',
        'Sabberworm\\CSS\\' => SCRIPT_DIR_VENDOR . '/sabberworm/php-css-parser/src',
        'Masterminds\\' => SCRIPT_DIR_VENDOR . '/masterminds/html5/src',
        'EtherpadLite\\' => SCRIPT_DIR_VENDOR . '/0x46616c6b/etherpad-lite-client/src/EtherpadLite',
    ];
