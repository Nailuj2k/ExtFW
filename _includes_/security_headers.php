<?php
    ...
    $is_public_json = preg_match(
        '#(^|/)json/?$#',
        parse_url($_SERVER['REQUEST_URI'], PHP_URL_PATH)
    );

    $access_control = $is_public_json 
                    || strpos($_SERVER['REQUEST_URI'],'sse') !== false 
                    || strpos($_SERVER['REQUEST_URI'],'marketplace')  !== false
                    || strpos($_SERVER['REQUEST_URI'],'shop')  !== false
                    || strpos($_SERVER['REQUEST_URI'],'pads')  !== false// || strpos($_SERVER['REQUEST_URI'],'sse') 
                    ? '*'
