...
HTML::js(SCRIPT_DIR_JS . '/wquery/wquery.js?v=A'.VERSION);          // Si se quiere usar jQuery en lugar de wQuery 
//HTML::js(SCRIPT_DIR_JS . '/jquery/jquery-3.7.1.min.js');          // se comenta la linea de wQuery y se usa una de estas dos.
//HTML::js(SCRIPT_DIR_JS . '/jquery/jquery-4.0.0-beta.2.min.js');   // O cualquier otra que queramos usar
...
HTML::js(SCRIPT_DIR_JS . '/bum/bum.js?ver=1.0.0','defer');
...
<canvas id="canvas" style="position:fixed;top:0;left:0;right:0;bottom:0;z-index:-1;"></canvas>
<?php
