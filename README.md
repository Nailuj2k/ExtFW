...
> © 2010–2026 Nailuj2k — Licencia MIT
...
|---|---|
| PHP | 8.0+ |
| SQLite (alternativa) | 3 | ó | MySQL / MariaDB | 5.7+ / 10.2+ |
| Apache | 2.2+ con `mod_rewrite` | ó  | Nginx | Equivalente a mod_rewrite |
...
```php
// _modules_/productos/init.php
 $db_engine = 'scaffold';
```

```php
// _modules_/productos/index.php
if   (OUTPUT == 'ajax')  include(SCRIPT_DIR_MODULE.'/ajax.php');
...
| `blog` | Blog con comentarios, rating, karma, etc. |
