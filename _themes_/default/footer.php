...
$_footer = '<div class="inner" style="display:block;text-align:center;">'
         . '  <img class="logo_footer editable-image-png" alt="Logo" src="/media/images/logo_footer.png?ver='.CFG::$vars['site']['lastupdate'].'" style="margin-top:10px;max-height:90px;"><br />'
