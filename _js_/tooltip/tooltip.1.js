...
const tooltip = (function() {
    ...
    const styles = `
        ...
        /* THEMES */
        .tooltip-container.theme-default {background: #333333; color: #fff; }
        .tooltip-container.theme-light   {background: #ffffff; color: #333; box-shadow: 0 2px 8px rgba(0,0,0,0.15);border: 1px solid #ddd;}
        .tooltip-container.theme-primary {background: #007bff; color: #fff; }
        .tooltip-container.theme-success {background: #28a745; color: #fff; }
        .tooltip-container.theme-danger  {background: #dc3545; color: #fff; }
        .tooltip-container.theme-tomato  {background: #ff6347; color: yellow; border:2px solid yellow; } /* thanks to tippy.js :). */
