(function($) {
        ...
        function getTypeOfContent(content){
            ...
            */
            if(typeof content  == 'object'){
              ...
              //else if (                            content.endsWith("/md")                            )   return 'iframe';
        ...
        return this.each(function() {
            ...
            if (settings.content) {    // Cargar contenido dinámico en el cuerpo del diálogo
                if (typeof settings.content === "string") {
                        ...
                        dialogBody.innerHTML = `<iframe src="${settings.content}" scrolling="auto"  style="min-width:801px;min-height:450px;margin-bottom:-4px;" NOstyle="width: 100%; height: 100%; border: none;"></iframe>`;
    ...
    $('body').on('click','.open_file_txt',function(e){
        ...
        let file_txt_title = $(this).attr('title') || $(this).data('title');
