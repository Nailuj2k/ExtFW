class EnhancedSelect extends HTMLElement {
    ...
    // Devuelve las etiquetas de las opciones seleccionadas saneadas como slugs/tags:
    // minusculas, sin tildes ni diacriticos, sin espacios ni simbolos. Usa el texto
    // visible (no el value, que para tags creados al vuelo lleva el prefijo "custom_").
    getSanitizedTags() {
